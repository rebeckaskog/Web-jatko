...
app.post("/api/resources", (req, res) => {
  ...
  const description = String(resourceDescription);   // description added so that it is visible in the terminal view
  ...
  console.log("Availability ➡️ ", available);   // availability added
