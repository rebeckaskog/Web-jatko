...
async function onSubmit(event) {
  ...
  const payload = {
    action: actionValue,
    resourceName: $("resourceName")?.value ?? "",               // typo fixed so name prints
  ...
  try {
    ...
    console.log("Price Unit ➡️ ", data.echo.resourcePriceUnit);   //price unit added so it shows up
